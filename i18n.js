...
export const langPack = {
    en: {
        ...
        aboutP1: 'Translator, scholar. After publishing the acclaimed 《荒原·情歌 <em>The Waste Land / The Love Song of J. Alfred Prufrock</em>》, a next-level translation of T.S. Eliot, Tao launched Acer Books to assist aspiring authors, poets and translators to bring their work to the world, with an eye on bridging cultures through finely crafted editions. Apart from the rich contents, every book\'s cover reflects an artist\'s eye — many photographs you see here are his own.',
        aboutP2: 'Montreal · distributed worldwide including Harvard Book Store, Oxford U Press, Hatchards, and Amazon.',
        aboutBtn: 'contact us ',
        ...
        footerAddr: '© 2026 Acer Books Canada, Montréal | Québec | Canada',
    ...
    fr: {
        ...
        aboutP1: 'Traducteur et universitaire. Après avoir publié la traduction saluée 《荒原·情歌 <em>The Waste Land / The Love Song of J. Alfred Prufrock</em>》, une relecture magistrale de T.S. Eliot, Tao a lancé Acer Books pour aider auteurs, poètes et traducteurs émergents à faire connaître leur œuvre, en jetant des ponts entre les cultures par des éditions finement réalisées. Au-delà de la richesse des contenus, chaque couverture reflète un regard d\'artiste — plusieurs photos que vous voyez ici sont les siennes.',
        aboutP2: 'Montréal · distribué dans le monde entier, dont Harvard Book Store, Oxford U Press, Hatchards et Amazon.',
